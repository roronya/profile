;(window.webpackJsonp = window.webpackJsonp || []).push([
  [4],
  {
    '/a9y': function (e, t, n) {
      ...
      ;(f.displayName = 'ErrorPage'), (t.default = f)
      var T = {
        error: {
          color: '#000',
          background: '#fff',
        ...
        return (function (r) {
          function c (e) {
            ...
            return (
              ...
              f && (t.add((0, u.default)(r)), n((0, u.default)(r))),
              r
            )
          }
          return (
        ...
        'Array',
        {
          from: function (e) {
            ...
            if (
              ...
              for (n = new f((t = l(s.length))); t > _; _++)
                d(n, _, R ? p(s[_], _) : s[_])
            else
              for (E = N.call(s), n = new f(); !(a = E.next()).done; _++)
