  ...
  [5],
  {
      ...
      ;(function (e) {
        ...
        if (
          ...
          ;(x = function (e, t) {
            ;(R = e),
              (O = t),
              N || 0 > t ? D.postMessage(void 0) : A || ((A = !0), w(B))
          }),
            (k = function () {
              ;(R = null), (I = !1), (O = -1)
            })
    ...
    '0KLy': function (e, t, n) {
      ...
      function k (e, t) {
        ...
        if (
          ...
          !b && 'undefined' != typeof window && 'function' == typeof r.webpack)
        ) {
          var h = r.webpack()
          _.push(function (e) {
            var t = !0,
    ...
    IKlv: function (e, t, n) {
      ...
      var k = x.props,
        ...
        O = M || ''
      ;(n.p = ''.concat(O, '/_next/')),
        _.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: R })
      var A = m.getURL(),
        N = new y.default(T, O),
        L = function (e) {
          var t = (0, i.default)(e, 2),
            n = t[0],
            r = t[1]
          return N.registerPage(n, r)
        }
      window.__NEXT_P && window.__NEXT_P.map(L),
        (window.__NEXT_P = []),
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 3:
                      return (
                        console.error(u), (e.next = 6), N.loadPage('/_error')
                      )
                    case 6:
                    ...
                    case 11:
                      return (
                        ...
                        m.loadGetInitialProps(r, {
                          ...
                          router: t.router,
                          ctx: { err: u, pathname: C, query: P, asPath: A }
                        })
                      )
                    case 13:
                      e.t0 = e.sent
      ...
      function z () {
        return (z = (0, u.default)(
          a.default.mark(function e (n) {
            var r, i, l, c, s, p, h, v, y, _, w, x
            return a.default.wrap(
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      ...
                      return (
                        ...
                        m.loadGetInitialProps(r, {
                          Component: i,
                          router: t.router,
                          ctx: { err: c, pathname: v, query: y, asPath: _ }
                        })
                      )
                    case 5:
                      l = e.sent
                      ...
                      ;(i = i || X.Component),
                        ...
                        (k = f.default.createElement(
                          ...
                          f.default.createElement(
                            ...
                            { value: D.updateHead },
                            f.default.createElement(r, (0, o.default)({}, w))
                          )
                        )),
                        (E = B),
                        U && 'function' == typeof d.default.hydrate
                          ? (d.default.hydrate(k, E), (U = !1))
